<template>
  <div class="target-type-container">
    ...
    <el-table :data="state.tableData" stripe border style="width: 100%">
      ...
      <el-table-column label="宝贝昵称" prop="typeId"></el-table-column>
      <el-table-column label="所属用户ID" prop="currentBabyId"></el-table-column>
      <el-table-column label="宝贝性别" prop="typeId"></el-table-column>
      <el-table-column label="宝贝积分" prop="typeId"></el-table-column>
